        ...
        <section>
            ...
            <main class="sidebar-user">
                ...
                <div class="fn-right">
                    ...
                    <a data-pjax href="${servePath}/dynamic.html">
        ...
        <section>
            ...
            <div class="sidebar-list">
                ...
                <#list mostUsedCategories as category>
                    ...
                    <a data-pjax href="${servePath}/category/${category.categoryURI}"
            ...
            <main class="sidebar-lists">
                <ul>
                    <#list mostCommentArticles as article>
                        <li>
                            <a data-pjax rel="nofollow" aria-label="${article.articleCommentCount} ${commentLabel}"
